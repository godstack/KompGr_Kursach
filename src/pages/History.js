...
export const History = () => {
  return (
    <div className="history">
      ...
      <div className="history_new-pic-1" />
      <div className="capture">За укриттям з Glock 23</div>
      <p>
      ...
      <div className="history_new-pic-2" />
      <div className="capture">Солдат SWAT тримає Glock 17 з глушником</div>
    </div>
  );
};
